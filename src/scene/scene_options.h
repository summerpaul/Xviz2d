 ...
 * @Last Modified time: 2024-06-22 14:31:38
 */
#include <stdint.h>
...
namespace scene
{
  struct SceneOptions
  {
    ...
    bool drawObject[14];
    int topDrawtype = SceneObjectType::POLYGON_ARRAY;
    std::string topDrawtypeStr =
        SceneObjectStr[SceneObjectType::POLYGON_ARRAY];
    int bottomDrawtype = SceneObjectType::POLYGON;
    std::string bottomDrawtypeStr =
        SceneObjectStr[SceneObjectType::POLYGON];
  };
} // namespace scene
